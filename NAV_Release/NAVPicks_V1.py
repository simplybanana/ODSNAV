...
while outerLoop == 1:
	...
	if (lookImageCheck("./releaseError.png") == True):
	...
	if(innerLoop == 1):
		...
		if (lookImageCheck("./completelyPicked.png") == True):
			pyautogui.press('esc')
			sleep(0.5)
			pyautogui.press('esc')
		sleep(1)
		if (nextButtonCheck == True):
			exit()
		else:
			nextButton()
	else:
		...
		registerButton()
		sleep(1)
		if (lookImageCheck("./yesButton.png") == True):
			pyautogui.press('left')
			sleep(timeInterval)
			pyautogui.press('enter')
			sleep(timeInterval)
		elif (lookImageCheck("./noBin.png") == True):
